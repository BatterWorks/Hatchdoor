...
| **6. Semantic index layer** | Stores and searches semantic representations. | Implemented — sqlite-vec virtual table (chunk_vectors). Runtime exposure via src/search/ (Phase 2). |
